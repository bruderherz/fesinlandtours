...
if(isset($_POST['email']) and isset($_POST['nom']) and isset($_POST['message']) )
{
        ...
        if(preg_match('#^(([a-z0-9!\#$%&\\\'*+/=?^_`{|}~-]+\.?)*[a-z0-9!\#$%&\\\'*+/=?^_`{|}~-]+)@(([a-z0-9-_]+\.?)*[a-z0-9-_]+)\.[a-z]{2,}$#i',str_replace('&amp;','&',$email)))
        {
                ...
                {
                        echo '<strong><p>Votre message a bien &eacute;t&eacute; envoy&eacute;</p><p><a href=contact-us.php>Revenir au formulaire</a></p><p></br><a href="contact-us.php">Revenir à l\'accueil</a></strong>';
                }
               
        }
        else
        {
                echo '<strong style=\"color:#ff0000;\"><p>L\'email que vous avez entr&eacute; est invalide.</p><p><a href=contact-us.php>Revenir au formulaire</a></strong>';
        }
}
else
{
			  ...
			  <div class="column3 contact">
					<div class="singup">
						...
						<form method="post" id="newsletter_subscribe" name="newsletter_form">
							...
							<input type="submit" name="submit" id="nl-submit" value="Soumettre"/>
						</form>
					</div>
				</div>
