...
<div id="container">
  ...
  <div class="head-banner clearfix mb30">
    <div class="wrapper">
      <h4>Hommes</h4>
      <div class="site_map">
        <a href="#">Vestes</a><a href="boutique.html"> Boutique</a>
      </div>
      <div class="clear"></div>
    </div>
  </div>
          ...
          <div class="product-grid dark">
              <div class="column4 grid-item">
                  <div class="view view-first">
                      <img src="images/portfolio/v-h/1.jpg" alt="shop1" />
                  </div>
                  <h4>Nom produit</h4>
...
<div id="wface">
 <div class="send-message">
    ...
    <a ><i id="oface" class="fa fa-random"></i></a>
              ...
              <div class="column4 grid-item">
                  <div class="view view-first">
                      <img src="images/portfolio/v-h/2.jpg" alt="shop1" />
                  </div>
                  <h4>Nom produit</h4>
                  <div class="end-product">
                    <div class="price">25.00</div>
              ...
              <div class="column4 grid-item">
                  <div class="view view-first">
                      <img src="images/portfolio/v-h/3.jpg" alt="shop1" />
                  </div>
                  <h4>Nom Produit</h4>
                  <div class="end-product">
                    <div class="price">25.00</div>
          ...
          <div class="product-grid dark">
              <div class="column4 grid-item">
                  <div class="view view-first">
                      <img src="images/portfolio/v-h/4.jpg" alt="shop1" />
                  </div>
                  <h4>Nom produit</h4>
                  <div class="end-product">
                    <div class="price">25.00</div>
              ...
              <div class="column4 grid-item">
                  <div class="view view-first">
                      <img src="images/portfolio/v-h/5.jpg" alt="shop1" />
                  </div>
                  <h4>Nom produit</h4>
                  <div class="end-product">
                    <div class="price">25.00</div>
              ...
              <div class="column4 grid-item">
                  <div class="view view-first">
                      <img src="images/portfolio/v-h/6.jpg" alt="shop1" />
                  </div>
                  <h4>Nom produit</h4>
                  <div class="end-product">
                    <div class="price">25.00</div>
          ...
          <div class="product-grid dark">
              <div class="column4 grid-item">
                  <div class="view view-first">
                      <img src="images/portfolio/v-h/7.jpg" alt="shop1" />
                  </div>
                  <h4>Nom produit</h4>
                  <div class="end-product">
                    <div class="price">25.00</div>
              ...
              <div class="column4 grid-item">
                  <div class="view view-first">
                      <img src="images/portfolio/v-h/8.jpg" alt="shop1" />
                  </div>
                  <h4>Nom produit</h4>
                  <div class="end-product">
                    <div class="price">25.00</div>
              ...
              <div class="column4 grid-item">
                  <div class="view view-first">
                      <img src="images/portfolio/v-h/9.jpg" alt="shop1" />
                  </div>
                  <h4>Nom produit</h4>
                  <div class="end-product">
                    <div class="price">25.00</div>
