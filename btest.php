              ...
              <div class="grid-item-list">
                  ...
                  <div class="grid-item-text">
                    ...
                    <div class="end-product">
                      ...
                      <a><button id="opener1">interéssé(e)</button></a>
              ...
              <div class="grid-item-list" >
                  ...
                  <div class="grid-item-text">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laudantium, quidem vel atque nemo quo repellat consectetur non modi aperiam. Est, beatae, pr?</p>
                     <div class="end-product">
                      <div class="price">25.00</div>
                     <a href="#"><i class="fa fa-heart"></i><b id="boldstuff1">0</b></a>
                     
                      
                      
                   
                      
                      <a><button id="opener">interéssé(e)</button></a>
<div id="wrapper">
               ...
               <div class="grid-item-list" >
                  ...
                  <div class="grid-item-text">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laudantium, quidem vel atque nemo quo repellat consectetur non modi aperiam. Est, beatae, pr?</p>
                     <div class="end-product">
                      <div class="price">25.00</div>
                     <a href="#"><i class="fa fa-heart" onclick="increase();" ></i><b id="boldstuff3"></b></a>
                      <a><button id="opener2">interéssé(e)</button></a>
                      <a href="#"><i class="fa fa-random"></i></a>
