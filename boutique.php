          ...
          <div class="product-grid dark">
              <div class="grid-item-list">
                  <div class="view view-first left-img" style="width:265px; height:240px;">
                      <img src="images/portfolio/b/1.jpg" alt="shop1"  style="width:259px; height:240px;"/>
                  </div>
              ...
              <div class="grid-item-list" >
                  <div class="view view-first left-img" style="width:265px; height:240px;">
                      <img src="images/portfolio/b/2.jpg" alt="shop1"  style="width:259px; height:240px;"/>
                  </div>
                  <div class="grid-item-text">
                    <h4>Product Name</h4>
...
<div id="wface">
 <div class="send-message">
    ...
    position: absolute;
    padding: 11px 0;">
                     <div class="f-socials" tyle="    margin-left: 1px;
    background: #4eccb9;
    position: absolute;
    padding: 11px 0;">
               ...
               <div class="grid-item-list" >
                  <div class="view view-first left-img" style="width:265px; height:240px;">
                      <img src="images/portfolio/b/3.jpg" alt="shop1"  style="width:259px; height:240px;"/>
                  </div>
                  <div class="grid-item-text">
                    <h4>Product Name</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laudantium, quidem vel atque nemo quo repellat consectetur non modi aperiam. Est, beatae, pr?</p>
